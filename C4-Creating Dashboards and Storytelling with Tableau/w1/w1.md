...
- Jot down initial version of 3-Cs: 
  - Context;
  - Challenge;
  - Preliminary options for the conclusion - also, alternate options for conclusion; 
- Balancing acts: 
  - All data may not be available; 
  - Need to reframe to represent data accurately;
  - Are you connecting with audience; 
  - Need to be reframe based on interview information?
  - Are you meeting stakeholder requirements; 
- Question to ask yourself: 
  - What level of detail does audience need?
  - Does data exist to show that level of detail? 
  - Does this align with stakeholder's goals? 
